...
name: code-agent
description: |
  Use this agent when the user needs help with development tasks, especially involving Neovim configuration, static site generation, CLI tooling, or publishing workflows. This includes:
